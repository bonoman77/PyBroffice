...
CREATE PROCEDURE set_client_insert(
    ...
    IN p_contractor_name VARCHAR(100),
    IN p_contractor_mobile VARCHAR(100),
    IN p_contractor_position VARCHAR(100),
...
BEGIN
    ...
    ELSE
        ...
        SET client_name = p_client_name,
            ...
            contractor_mobile = p_contractor_mobile,
            contractor_position = p_contractor_position,
