...
CREATE TABLE task_schedules (
    ...
    memo                  VARCHAR(500) NULL COMMENT '메모',
    scheduled_date        DATETIME NOT NULL COMMENT '생성일정',
    change_scheduled_yn   TINYINT(1) DEFAULT 0 NOT NULL COMMENT '변경여부',
    change_user_id        INT NULL COMMENT '관리자ID',
...
CREATE TABLE tasks (
    ...
    days_of_week          VARCHAR(30) NOT NULL COMMENT '복수선택요일',
    fix_dates             VARCHAR(30) NOT NULL COMMENT '복수고정날짜',
	use_yn				  TINYINT(1) DEFAULT 0 NOT NULL COMMENT '사용여부',
...
CREATE TABLE users (
	...
	use_yn				  TINYINT(1) DEFAULT 0 NOT NULL COMMENT '사용여부',
	manager_yn			  TINYINT(1) DEFAULT 0 NOT NULL COMMENT '관리자여부',
